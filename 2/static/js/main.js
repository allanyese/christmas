	...
	return {
		...
		countdownInit: function () {
			$('#countdown_container').countdown('2021/12/25', function (event) {
				$(this).html(event.strftime('<div class="col-md-3 col-xs-3 countdown-globe" title="l">%D<div class="col-md-12 padding-none">Days</div></div>\
					<div class="col-md-3 col-xs-3 countdown-globe" title="o">%H<div class="col-md-12 padding-none">Hours</div></div>\
					<div class="col-md-3 col-xs-3 countdown-globe" title="v">%M<div class="col-md-12 padding-none">Minutes</div></div>\
					<div class="col-md-3 col-xs-3 countdown-globe" title="e">%S<div class="col-md-12 padding-none">Seconds</div></div>'));
			});
		}
	}
})($);
